...
- **20260830 - Rearrange the code structure. Bugs fix and add some features.** Add `dynamic fade` to improve seam removal. Add `brightness match` to to help reduce brightness flickering.
